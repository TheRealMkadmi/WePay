        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-7 col-xs-12 mb20 marginTopPlus">
                    ...
                    <form id="depositForm1" action="{{ url('payout/cart-confirmer') }}" method="post" accept-charset='UTF-8'>
                        <div class="card">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">SMS de vérification DigiiGo</label>
