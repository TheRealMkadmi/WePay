                    ...
                    <div class="d-flex flex-wrap justify-content-between">
                        <div>
                            <div class="d-flex flex-wrap">
                                <a href="{{url('/deposit')}}">
                                    <div class="mr-4 pb-3">
                                        <p class="text-16 font-weight-400 text-gray-500">{{ __('Liste de dépôt') }}</p>
                                    </div>
                                </a>
                                                ...
                                                <tbody>
                                                    @foreach($payoutSettings as $row)
                                                        <tr class="row_id_{{$row->id}}">
                                                            ...
                                                            <td class="pl-5">
                                                                <form action="{{ url('deposit/cart-stb-deposit')}}" method="post">
                                                                    @csrf
                                                            ...
                                                            <td class="pr-5 text-right">
                                                                ...
                                                                <!-- <a id="editBtn" href="{{url('deposit/cart-setting/update/')}}" data-id="{{$row->id}}" data-type="{{$row->type}}" data-obj="{{json_encode($row->getAttributes())}}" class="btn btn-sm btn-light mr-lg-2 mt-2 edit-setting"><i class="far fa-edit"></i></a> -->
                                                                <form action="{{url('deposit/cart-setting/delete'.$row->id)}}" method="post" style="display: inline">
                                                                    @csrf
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                <div class="modal-header" style="display: block;">
                    ...
                    <h4 class="modal-title">Paramètre de carte STB</h4>
                </div>
...
@section('js')
    ...
    <script>
        ...
        $('#addBtn').on('click', function(e)
        {
            ...
            form.attr('action', '{{url('deposit/cart-setting/store')}}');
        ...
        $('#editBtn').on('click', function(e)
        {
            ...
            var form = $('#payoutSettingForm');
            form.attr('action', '{{url('deposit/cart-setting/update')}}');
