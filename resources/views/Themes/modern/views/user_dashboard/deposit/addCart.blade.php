        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7 col-xs-12 mb20 marginTopPlus">
                    ...
                    <form action="{{ url('cart-stb-deposit') }}" style="display: block;" method="POST"
                        ...
                        <div class="card">
                            ...
                            <div class="wap-wed mt20 mb20">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="amount"  value="{{$coinpaymentAmount}}"  placeholder="0.000" type="text" >
