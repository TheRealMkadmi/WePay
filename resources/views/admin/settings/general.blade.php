        ...
        <div class="box box-info">
            ...
            <form action="{{ url(\Config::get('adminPrefix').'/settings') }}" method="post" class="form-horizontal" enctype="multipart/form-data" id="general_settings_form">
                ...
                <!-- box-body -->
                  ...
                  <!-- Code d’institution -->
                  <div class="form-group">
                  <label class="col-sm-4 control-label" for="my-input">Code d’institution</label>
                    <div class="col-sm-6">
                      <textarea name="Code_inst" id="input" placeholder="Code d’institution" class="form-control" rows="3" required="required"></textarea>
