            ...
            <div class="box box-info">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs" id="tabs">
                        ...
                        <li class="active"><a href="{{ url(\Config::get('adminPrefix').'/settings/sms/nexmo')}}">Nexmo</a></li>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div style="margin-top:10px">
                                                        <a id="cancel_anchor" href="{{ url(\Config::get('adminPrefix').'/settings/sms/nexmo') }}" class="btn btn-theme-danger">Cancel</a>
                                                        <button type="submit" class="btn btn-theme pull-right" id="sms-settings-nexmo-submit-btn">
