...
@section('page_content')
	...
	<div class="box">
	  <div class="box-body">
	    <div class="dropdown">
	        <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">Devise : <span class="currencyName">{{ $currency->name }}</span>
			...
			<div class="box box-info">
				...
				<form action='{{url('admin/settings/payment-methods/update-paymentMethod-Credentials')}}' class="form-horizontal" method="POST" id="currencyPaymentMethod_form">
					...
					<div class="box-body">
						...
						<input type="hidden" value="" name="processing_time">
							<!-- paypal - Client ID -->
							<div class="form-group">
							...
							@elseif ($list_menu == 'clictopay') 

							<input class="form-control" name="processing_time" type="hidden" 
									value="{{ isset($currencyPaymentMethod->processing_time) ? $currencyPaymentMethod->processing_time : '' }}" id="processing_time">
							<!-- clictopay - username -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="clictopay[username]">Username</label>
								<div class="col-sm-5">
									<input class="form-control" name="clictopay[username]" type="text" placeholder="Username"
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->username : '' }}" id="clictopay_name">

									@if ($errors->has('clictopay[username]'))
									<span class="help-block">
										<strong>{{ $errors->first('clictopay[username]') }}</strong>
									</span>
									@endif
								</div>
							</div>
							...
							<!-- clictopay - password -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="clictopay[password]">Password</label>
								<div class="col-sm-5">
									<input class="form-control" name="clictopay[password]" type="text" placeholder="Password"
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->password : '' }}" id="clictopay_password">
									@if ($errors->has('clictopay[password]'))
									<span class="help-block">
										<strong>{{ $errors->first('clictopay[password]') }}</strong>
									</span>
									@endif
								</div>
							</div>
							...
							<!-- clictopay - Mode -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="clictopay[mode]">Mode</label>
								<div class="col-sm-5">
									<select class="form-control" name="clictopay[mode]" id="clictopay_mode">
										<option value="">Select Mode</option>
										<option value='sandbox' {{ isset($currencyPaymentMethod->method_data) && (json_decode($currencyPaymentMethod->method_data)->mode) == 'sandbox' ? 'selected':"" }} >sandbox</option>
										<option value='live' {{ isset($currencyPaymentMethod->method_data) && (json_decode($currencyPaymentMethod->method_data)->mode) == 'live' ? 'selected':"" }} >live</option>
									</select>
							...
							<!-- clictopay - Status -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="clictopay_status">Status</label>
								<div class="col-sm-5">
									<select class="form-control" name="clictopay_status" id="clictopay_status">
										<option value=''>Select Status</option>
							...
							<!-- clictopay - processing_time -->
							<div class="form-group">
								<div class="col-sm-5">
									<input class="form-control" name="processing_time" type="hidden" placeholder="2Checkout Processing Time"
									value="0">
								</div>
							</div>
							<div class="clearfix"></div>
							...
							@elseif ($list_menu == 'CompteStb') 
							<input class="form-control" name="processing_time" type="hidden" 
									value="{{ isset($currencyPaymentMethod->processing_time) ? $currencyPaymentMethod->processing_time : '' }}" id="processing_time">							<!-- CompteStb - username -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="CompteStb[username]">Username</label>
								<div class="col-sm-5">
									<input class="form-control" name="CompteStb[username]" type="text" placeholder="Username"
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->username : '' }}" id="CompteStb_name">

									@if ($errors->has('CompteStb[username]'))
									<span class="help-block">
										<strong>{{ $errors->first('CompteStb[username]') }}</strong>
									</span>
									@endif
								</div>
							</div>
							...
							<!-- CompteStb - password -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="CompteStb[password]">Password</label>
								<div class="col-sm-5">
									<input class="form-control" name="CompteStb[password]" type="text" placeholder="Password"
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->password : '' }}" id="CompteStb_password">
									@if ($errors->has('CompteStb[password]'))
									<span class="help-block">
										<strong>{{ $errors->first('CompteStb[password]') }}</strong>
									</span>
									@endif
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="CompteStb[client_id]">Client ID</label>
								<div class="col-sm-5">
									<input class="form-control" name="CompteStb[client_id]" type="text" placeholder="Client ID"
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->client_id : '' }}" id="CompteStb_client_id">
									@if ($errors->has('CompteStb[client_id]'))
									<span class="help-block">
										<strong>{{ $errors->first('CompteStb[client_id]') }}</strong>
									</span>
									@endif
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="CompteStb[grant_type]">Grant type</label>
								<div class="col-sm-5">
									<input class="form-control" name="CompteStb[grant_type]" type="text" placeholder="Grant type"
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->grant_type : '' }}" id="CompteStb_grant_type">
									@if ($errors->has('CompteStb[grant_type]'))
									<span class="help-block">
										<strong>{{ $errors->first('CompteStb[grant_type]') }}</strong>
									</span>
									@endif
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="CompteStb[scope]">Scope</label>
								<div class="col-sm-5">
									<input class="form-control" name="CompteStb[scope]" type="text" placeholder="Scope"
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->scope : '' }}" id="CompteStb_scope">
									@if ($errors->has('CompteStb[scope]'))
									<span class="help-block">
										<strong>{{ $errors->first('CompteStb[scope]') }}</strong>
									</span>
									@endif
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="CompteStb[response_type]">Response type</label>
								<div class="col-sm-5">
									<input class="form-control" name="CompteStb[response_type]" type="text" placeholder="Response type"
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->response_type : '' }}" id="CompteStb_response_type">
									@if ($errors->has('CompteStb[response_type]'))
									<span class="help-block">
										<strong>{{ $errors->first('CompteStb[response_type]') }}</strong>
									</span>
									@endif
								</div>
							</div>
							...
							<!-- CompteStb - Mode -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="CompteStb[mode]">Mode</label>
								<div class="col-sm-5">
									<select class="form-control" name="CompteStb[mode]" id="CompteStb_mode">
										<option value="">Select Mode</option>
										<option value='sandbox' {{ isset($currencyPaymentMethod->method_data) && (json_decode($currencyPaymentMethod->method_data)->mode) == 'sandbox' ? 'selected':"" }} >sandbox</option>
										<option value='live' {{ isset($currencyPaymentMethod->method_data) && (json_decode($currencyPaymentMethod->method_data)->mode) == 'live' ? 'selected':"" }} >live</option>
									</select>
							...
							<!-- CompteStb - Status -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="CompteStb_status">Status</label>
								<div class="col-sm-5">
									<select class="form-control" name="CompteStb_status" id="CompteStb_status">
										<option value=''>Select Status</option>
							...
							@elseif ($list_menu == 'CarteStb')
							<input class="form-control" name="processing_time" type="hidden" 
									value="{{ isset($currencyPaymentMethod->processing_time) ? $currencyPaymentMethod->processing_time : '' }}" id="processing_time">							<!-- CarteStb - username -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="CarteStb[username]">Username</label>
								<div class="col-sm-5">
									<input class="form-control" name="CarteStb[username]" type="text" placeholder="Username"
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->username : '' }}" id="CarteStb_name">

									@if ($errors->has('CarteStb[username]'))
									<span class="help-block">
										<strong>{{ $errors->first('CarteStb[username]') }}</strong>
									</span>
									@endif
								</div>
							</div>
							...
							<!-- CarteStb - password -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="CarteStb[password]">Password</label>
								<div class="col-sm-5">
									<input class="form-control" name="CarteStb[password]" type="text" placeholder="Password"
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->password : '' }}" id="CarteStb_password">
									@if ($errors->has('CarteStb[password]'))
									<span class="help-block">
										<strong>{{ $errors->first('CarteStb[password]') }}</strong>
									</span>
									@endif
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="CarteStb[client_id]">Client ID</label>
								<div class="col-sm-5">
									<input class="form-control" name="CarteStb[client_id]" type="text" placeholder="Client ID"
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->client_id : '' }}" id="CarteStb_client_id">
									@if ($errors->has('CarteStb[client_id]'))
									<span class="help-block">
										<strong>{{ $errors->first('CarteStb[client_id]') }}</strong>
									</span>
									@endif
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="CarteStb[grant_type]">Grant type</label>
								<div class="col-sm-5">
									<input class="form-control" name="CarteStb[grant_type]" type="text" placeholder="Grant type"
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->grant_type : '' }}" id="CarteStb_grant_type">
									@if ($errors->has('CarteStb[grant_type]'))
									<span class="help-block">
										<strong>{{ $errors->first('CarteStb[grant_type]') }}</strong>
									</span>
									@endif
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="CarteStb[scope]">Scope</label>
								<div class="col-sm-5">
									<input class="form-control" name="CarteStb[scope]" type="text" placeholder="Scope"
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->scope : '' }}" id="CarteStb_scope">
									@if ($errors->has('CarteStb[scope]'))
									<span class="help-block">
										<strong>{{ $errors->first('CarteStb[scope]') }}</strong>
									</span>
									@endif
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="CarteStb[response_type]">Response type</label>
								<div class="col-sm-5">
									<input class="form-control" name="CarteStb[response_type]" type="text" placeholder="Response type"
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->response_type : '' }}" id="CarteStb_response_type">
									@if ($errors->has('CarteStb[response_type]'))
									<span class="help-block">
										<strong>{{ $errors->first('CarteStb[response_type]') }}</strong>
									</span>
									@endif
								</div>
							</div>
							...
							<!-- CarteStb - Mode -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="CarteStb[mode]">Mode</label>
								<div class="col-sm-5">
									<select class="form-control" name="CarteStb[mode]" id="CarteStb_mode">
										<option value="">Select Mode</option>
										<option value='sandbox' {{ isset($currencyPaymentMethod->method_data) && (json_decode($currencyPaymentMethod->method_data)->mode) == 'sandbox' ? 'selected':"" }} >sandbox</option>
										<option value='live' {{ isset($currencyPaymentMethod->method_data) && (json_decode($currencyPaymentMethod->method_data)->mode) == 'live' ? 'selected':"" }} >live</option>
									</select>
							...
							<!-- CarteStb - Status -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="CarteStb_status">Status</label>
								<div class="col-sm-5">
									<select class="form-control" name="CarteStb_status" id="CarteStb_status">
										<option value=''>Select Status</option>
					...
					<div class="modal-dialog modal-lg">
						...
						<div class="modal-content">
							<div class="modal-header" style="display: block;">
								...
								<h4 class="modal-title text-center">Ajouter des informations bancaires</h4>
							</div>
							...
							<form id="add-bank" method="post" enctype="multipart/form-data">
								...
								<div class="modal-footer">
									<div class="row">
										<div class="col-md-12">
											<div class="col-md-1"></div>
											<div class="col-md-4"><button type="button" class="btn btn-danger btn-flat pull-left" data-dismiss="modal">Fermer</button></div>
											<div class="col-md-2"></div>
											<div class="col-md-4">
												<button type="submit" class="btn btn-primary btn-flat pull-right" id="submit_btn">Soumettre</button>
											</div>
										</div>
									</div>
								</div>
				...
				<div class="modal fade" id="editModal" role="dialog">
					<div class="modal-dialog modal-lg">
						...
						<div class="modal-content">
							<div class="modal-header" style="display: block;">
								<button type="button" class="close" data-dismiss="modal">&times;</button>
								<h4 class="modal-title text-center">Modifier les détails de la banque</h4>
							</div>
								...
								<div class="modal-footer">
									<div class="row">
										<div class="col-md-12">
											...
											<div class="col-md-2"></div>
											<div class="col-md-4">
												<button type="submit" class="btn btn-primary btn-flat pull-right" id="edit_submit_btn">Mettre à jour</button>
											</div>
										</div>
									</div>
								</div>
...
<script type="text/javascript">
    ...
    $('#currencyPaymentMethod_form').validate({
        rules: {
			...
			"CompteStb[response_type]": {
                required: true,
            },
			"CompteStb[scope]": {
                required: true,
            },
			"CompteStb[grant_type]": {
                required: true,
            },
			"CompteStb[username]": {
                required: true,
		...
		$.ajax({
			...
			success:function(data)
			{
				...
				if(data.status == 200)
				{
					...
					$('#CompteStb_client_id').val(JSON.parse(data.currencyPaymentMethod.method_data).client_id);
					$('#CarteStb_client_id').val(JSON.parse(data.currencyPaymentMethod.method_data).client_id);
					$('#CompteStb_grant_type').val(JSON.parse(data.currencyPaymentMethod.method_data).grant_type);
					$('#CarteStb_grant_type').val(JSON.parse(data.currencyPaymentMethod.method_data).grant_type);
					$('#CompteStb_scope').val(JSON.parse(data.currencyPaymentMethod.method_data).scope);
					$('#CarteStb_scope').val(JSON.parse(data.currencyPaymentMethod.method_data).scope);
					$('#CompteStb_response_type').val(JSON.parse(data.currencyPaymentMethod.method_data).response_type);
					$('#CarteStb_response_type').val(JSON.parse(data.currencyPaymentMethod.method_data).response_type);
					$('#clictopay_name').val(JSON.parse(data.currencyPaymentMethod.method_data).username); 
					$('#CompteStb_name').val(JSON.parse(data.currencyPaymentMethod.method_data).username);
					$('#CarteStb_name').val(JSON.parse(data.currencyPaymentMethod.method_data).username);
					$('#paypal_client_secret').val(JSON.parse(data.currencyPaymentMethod.method_data).client_secret);
					$('#clictopay_password').val(JSON.parse(data.currencyPaymentMethod.method_data).password);
					$('#CompteStb_password').val(JSON.parse(data.currencyPaymentMethod.method_data).password);
					$('#CarteStb_password').val(JSON.parse(data.currencyPaymentMethod.method_data).password);
					$('#paypal_mode').val(JSON.parse(data.currencyPaymentMethod.method_data).mode);
					$('#clictopay_mode').val(JSON.parse(data.currencyPaymentMethod.method_data).mode);
					$('#CompteStb_mode').val(JSON.parse(data.currencyPaymentMethod.method_data).mode);
					$('#CarteStb_mode').val(JSON.parse(data.currencyPaymentMethod.method_data).mode);
					...
					if(activated_for.hasOwnProperty('deposit'))
					{
						...
						$('#clictopay_status').val('Active');
						$('#CompteStb_status').val('Active');
						$('#CarteStb_status').val('Active');
					...
					else
					{
					  ...
					  $('#clictopay_status').val('Inactive');
					  $('#CompteStb_status').val('Inactive');
					  $('#CarteStb_status').val('Inactive');
				...
				else
				{
					...
					$('#CompteStb_client_id').val('');
					$('#CarteStb_client_id').val('');
					$('#CompteStb_grant_type').val('');
					$('#CarteStb_grant_type').val('');
					$('#CompteStb_scope').val('');
					$('#CarteStb_scope').val('');
					$('#CompteStb_response_type').val('');
					$('#CarteStb_response_type').val('');
					$('#clictopay_name').val('');
					$('#CompteStb_name').val('');
					$('#CarteStb_name').val('');
					$('#paypal_client_secret').val('');
					$('#clictopay_password').val('');
					$('#CompteStb_password').val('');
					$('#CarteStb_password').val('');
					$('#paypal_mode').val('');
					$('#clictopay_mode').val('');
					$('#CompteStb_mode').val('');
					$('#CarteStb_mode').val('');
					...
					$('#stripe_status').val('');
					$('#paypal_status').val('');
					$('#clictopay_status').val('');
					$('#CompteStb_status').val('');
					$('#CarteStb_status').val('');
