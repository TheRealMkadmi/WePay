...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->command->info('Sms Templates Table Seeded Successfully!');
        ...
        $this->call(ClicToPayParametersSeeder::class);
        $this->command->info('ClicToPay Parameters Seeded Successfully!');

        $this->call(ClicToPayPaymentSeeder::class);
        $this->command->info('ClicToPay Payment Seeded Successfully!');
