...
Route::group(['middleware' => ['guest:users', 'locale', 'twoFa', 'check-user-inactive'], 'namespace' => 'Users'], function ()
{
    ...
    Route::group(['middleware' => ['permission:manage_setting']], function ()
    {
        ...
        Route::post('profile/add-digigo', 'CustomerController@addDigigo');
        Route::match(array('GET', 'POST'), 'profile/digigo-sms', 'CustomerController@digigoSms');
    ...
    Route::group(['middleware' => ['permission:manage_deposit', 'check-user-suspended']], function ()
    {
        ...
        //ClicToPay
        Route::match(array('GET', 'POST'), 'deposit/clictopay-finish', 'DepositController@clictopayFinish');
        Route::get('deposit/clictopay-payment/success', 'DepositController@clictopayDepositPaymentSuccess')->name('deposit.stripe.clictopay');

        //STB
        Route::match(array('GET', 'POST'), 'deposit/compte-stb-deposit', 'DepositController@compteStbDeposit');
        Route::post('deposit/setting/update', 'DepositController@depositSettingUpdate');
        Route::post('deposit/setting/delete', 'DepositController@depositSettingDestroy');
        Route::post('deposit/setting/store', 'DepositController@depositSettingStore');

        Route::post('deposit/cart-setting/store', 'DepositController@depositCartSettingStore');
        Route::post('deposit/cart-setting/update', 'DepositController@depositCartSettingUpdate');
        Route::post('deposit/cart-setting/delete', 'DepositController@depositCartSettingDestroy');


        Route::get('deposit/setting', 'DepositController@depositSetting');
        Route::get('deposit/cart-setting', 'DepositController@depositCartSetting');
        Route::match(array('GET', 'POST'), 'deposit/stb-deposit', 'DepositController@stbDeposit');

        Route::match(array('GET', 'POST'), 'deposit/cart-stb-deposit', 'DepositController@cartStbDeposit');


        Route::match(array('GET', 'POST'), 'deposit/stb-deposit-sms', 'DepositController@stbDepositSms');
        Route::match(array('GET', 'POST'), 'deposit/cart-stb-deposit-sms', 'DepositController@cartStbDepositSms');


        Route::post('deposit/confirmer', 'DepositController@stbDepositConfirm');
        Route::post('deposit/cart-confirmer', 'DepositController@stbDepositCartConfirm');
        Route::get('deposit/compte-stb-payment/success', 'DepositController@compteStbDepositPaymentSuccess')->name('deposit.stripe.compteStb');
    ...
    Route::group(['middleware' => ['permission:manage_withdrawal', 'check-user-suspended']], function ()
    {
        ...
        Route::match(array('GET', 'POST'), 'payout/stb-payout-sms', 'WithdrawalController@stbPayoutSms');
        Route::match(array('GET', 'POST'), 'payout/cart-stb-payout-cartSms', 'WithdrawalController@cartStbPayoutSms');

        Route::post('payout/confirmer', 'WithdrawalController@stbPayoutConfirm');
        Route::post('payout/cart-confirmer', 'WithdrawalController@cartStbPayoutConfirm');
    });
...
//clicToPay
Route::post('payment/clictopay', 'MerchantPaymentController@clicToPayPayment'); 
Route::get('payment/clictopay-finish', 'MerchantPaymentController@clicToPayFinish');
